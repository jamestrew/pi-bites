...
export function registerAskUserQuestionTool(pi: ExtensionAPI): void {
  const OptionSchema = Type.Object({
    ...
    recommended: Type.Optional(
      Type.Boolean({
        description:
          "Mark this option as recommended — renders a ★ Recommended badge below its label",
      }),
    ),
  });
  ...
  pi.registerTool({
    ...
    promptGuidelines: [
      ...
      "If you recommend a specific option, set its recommended field to true — this renders a ★ Recommended badge below the label.",
    ],
