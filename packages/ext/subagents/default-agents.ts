...
export const DEFAULT_AGENTS: Readonly<Record<SubagentType, AgentConfig>> = Object.freeze({
  ...
  explorer: Object.freeze({
    ...
    description: [
      ...
      "Partition the explorer's scope before launching: keep files and searches you will handle out of its prompt. After launch, do not inspect delegated files or topics and do not repeat its searches or reads while it runs; continue only non-overlapping work, or wait if its result blocks progress.",
