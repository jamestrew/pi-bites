...
const retainedGroups = [
  ...
  /^web-run\.test\.ts$/,
  /^code-mode(?:-(?:runtime|connection))?\.test\.ts$/,
  /^code-mode\/(?:(?:binary|runtime|lifecycle|delegates|exec-source|types|host-connection|host-process|host-protocol)\.ts|vendor-inventory\.json)$/,
