...
4. Regenerate reduced Cargo lockfiles, run all locked Cargo test/build pairs, strip the Linux x86-64 executables, replace only the four documented artifacts, and update their SHA-256 values here and in `vendor-boundary.test.ts`.
